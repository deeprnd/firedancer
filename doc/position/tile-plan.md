...
The current in-process runtime runs a synthetic payment pipeline:
...
These steps describe architectural prerequisites, not product delivery phases.
They explain which runtime guarantees must exist before later tile classes are
meaningful.
...
Product work, acceptance criteria, and release sequencing are intentionally out
of scope here. This document records tile identity, ownership, topology, and
