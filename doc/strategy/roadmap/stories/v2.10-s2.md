...
Used for: build.zig refactor to <500 lines via declarative modules + walk-based
registration
...
- [ ] N/A - build script refactor; no policy changes.

**Audit and replay**

- [ ] N/A - build script refactor; no audit/replay changes.
