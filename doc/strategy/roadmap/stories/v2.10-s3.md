...
Used for: Qt 6 CMake build POC for V3.19 investment terminal
...
- [ ] N/A - build POC only; no policy implementation.

**Audit and replay**

- [ ] N/A - build POC only; no audit/replay implementation.
