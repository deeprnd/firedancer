...
- V1.3.S4.T2: Save the AI infrastructure thesis card and supplier payout
  proposal card.
- V1.3.S4.T3: Apply deterministic market movement and approval-expiry fixtures.
- V1.3.S4.T4: Show thesis drift, cash-buffer alert, approval expiry, and
  rebalance suggestion.
...
**Scope:** Rebaseline the classification evidence migration after the V1.14
