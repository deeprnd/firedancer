...
Used for: justfile fully-qualified recipe names, dispatcher cleanup,
test-unit-fd cross-platform spike

Read before filling:
  - doc/strategy/templates/status-template.md
  ...
  - doc/execution/testing-tickoni.md and doc/execution/ci.md
  - doc/execution/security.md
  - doc/execution/observability.md and doc/execution/telemetry.md
-->
...
- [ ] N/A - build system changes; no policy changes.

**Audit and replay**

- [ ] N/A - build system changes; no audit/replay changes.
