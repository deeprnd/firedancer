...
static const uint sock_filter_policy_fd_execle_tile_instr_cnt = 0;

static void populate_sock_filter_policy_fd_execle_tile( ulong out_cnt, struct sock_filter out[ static 1 ], uint logfile_fd ) {
  (void)out_cnt;
  (void)out;
  (void)logfile_fd;
