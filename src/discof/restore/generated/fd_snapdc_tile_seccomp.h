...
static const uint sock_filter_policy_fd_snapdc_tile_instr_cnt = 22;

static void populate_sock_filter_policy_fd_snapdc_tile( ulong out_cnt, struct sock_filter out[ static 22 ], uint logfile_fd ) {
  FD_TEST( out_cnt >= 22 );
...
static const uint sock_filter_policy_fd_snapdc_tile_instr_cnt = 0;

static void populate_sock_filter_policy_fd_snapdc_tile( ulong out_cnt, struct sock_filter out[ static 1 ], uint logfile_fd ) {
  (void)out_cnt;
  (void)out;
  (void)logfile_fd;
...
#endif /* HEADER_fd_src_discof_restore_generated_fd_snapdc_tile_seccomp_h */
