...
fn makeFixtures() [12]FixtureSpec {
    ...
    return .{
        .{
            ...
            .expected_binary_len = 113,
            .expected_binary_bytes = &.{ 0x6D, 0x00, 0x00, 0x00, 0x08, 0x01, 0x18, 0x01, 0x20, 0x0A, 0x2A, 0x06, 0x74, 0x6B, 0x69, 0x6E, 0x67, 0x73, 0x30, 0xE9, 0x07, 0x3A, 0x11, 0x70, 0x6F, 0x6C, 0x69, 0x63, 0x79, 0x5F, 0x69, 0x6E, 0x67, 0x72, 0x65, 0x73, 0x73, 0x5F, 0x76, 0x31, 0x42, 0x10, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x48, 0x6F, 0x50, 0xF4, 0x03, 0x58, 0xE7, 0x94, 0x9C, 0xB6, 0xE1, 0xE3, 0xAA, 0x83, 0x4A, 0x62, 0xA2, 0x80, 0x80, 0x80, 0x00, 0x0A, 0x0A, 0x66, 0x65, 0x65, 0x64, 0x5F, 0x61, 0x6C, 0x70, 0x68, 0x61, 0x12, 0x11, 0x70, 0x61, 0x79, 0x6D, 0x65, 0x6E, 0x74, 0x5F, 0x65, 0x78, 0x63, 0x65, 0x70, 0x74, 0x69, 0x6F, 0x6E, 0x18, 0xA9, 0x46 },
        },
        .{
            .event = events[1],
            .expected_hash = 687536181503956794,
            .expected_binary_len = 103,
            .expected_binary_bytes = &.{ 0x63, 0x00, 0x00, 0x00, 0x08, 0x01, 0x18, 0x02, 0x20, 0x0B, 0x2A, 0x06, 0x74, 0x6B, 0x6E, 0x6F, 0x72, 0x6D, 0x30, 0xEA, 0x07, 0x3A, 0x0E, 0x70, 0x6F, 0x6C, 0x69, 0x63, 0x79, 0x5F, 0x6E, 0x6F, 0x72, 0x6D, 0x5F, 0x76, 0x31, 0x42, 0x10, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x48, 0xDE, 0x01, 0x50, 0xF5, 0x03, 0x58, 0xBA, 0xAE, 0x96, 0xE6, 0xBA, 0xD0, 0xA7, 0xC5, 0x09, 0x6A, 0x9A, 0x80, 0x80, 0x80, 0x00, 0x08, 0xA9, 0x46, 0x10, 0xAA, 0x46, 0x1A, 0x12, 0x70, 0x61, 0x79, 0x6D, 0x65, 0x6E, 0x74, 0x2E, 0x6E, 0x6F, 0x72, 0x6D, 0x61, 0x6C, 0x69, 0x7A, 0x65, 0x64 },
        },
        .{
            .event = events[2],
            .expected_hash = 2343529048530967501,
            .expected_binary_len = 98,
            .expected_binary_bytes = &.{ 0x5E, 0x00, 0x00, 0x00, 0x08, 0x01, 0x18, 0x03, 0x20, 0x0C, 0x2A, 0x06, 0x74, 0x6B, 0x70, 0x6F, 0x6C, 0x79, 0x30, 0xEB, 0x07, 0x3A, 0x0E, 0x70, 0x6F, 0x6C, 0x69, 0x63, 0x79, 0x5F, 0x70, 0x6F, 0x6C, 0x79, 0x5F, 0x76, 0x31, 0x42, 0x10, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x48, 0xCD, 0x02, 0x50, 0xF6, 0x03, 0x58, 0xCD, 0xB7, 0xFD, 0xD3, 0x8C, 0xE8, 0xF8, 0xC2, 0x20, 0x72, 0x95, 0x80, 0x80, 0x80, 0x00, 0x08, 0x02, 0x10, 0x2A, 0x1A, 0x0C, 0x61, 0x6D, 0x6F, 0x75, 0x6E, 0x74, 0x5F, 0x6C, 0x69, 0x6D, 0x69, 0x74, 0x20, 0xAA, 0x46 },
        },
        .{
            .event = events[3],
            .expected_hash = 9348858478567441182,
            .expected_binary_len = 106,
            .expected_binary_bytes = &.{ 0x66, 0x00, 0x00, 0x00, 0x08, 0x01, 0x18, 0x04, 0x20, 0x0D, 0x2A, 0x06, 0x74, 0x6B, 0x6D, 0x6F, 0x64, 0x6C, 0x30, 0xEC, 0x07, 0x3A, 0x0F, 0x70, 0x6F, 0x6C, 0x69, 0x63, 0x79, 0x5F, 0x6D, 0x6F, 0x64, 0x65, 0x6C, 0x5F, 0x76, 0x31, 0x42, 0x10, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x48, 0xBC, 0x03, 0x50, 0xF7, 0x03, 0x58, 0x9E, 0x86, 0xA5, 0xF3, 0x8F, 0xA8, 0xF4, 0xDE, 0x81, 0x01, 0x7A, 0x9B, 0x80, 0x80, 0x80, 0x00, 0x0A, 0x0E, 0x67, 0x70, 0x74, 0x5F, 0x6C, 0x6F, 0x63, 0x61, 0x6C, 0x5F, 0x73, 0x74, 0x75, 0x62, 0x10, 0x8C, 0x47, 0x18, 0x8D, 0x47, 0x20, 0x80, 0x04, 0x28, 0x02 },
        },
        .{
            .event = events[4],
            .expected_hash = 8966421440037456976,
            .expected_binary_len = 99,
            .expected_binary_bytes = &.{ 0x5F, 0x00, 0x00, 0x00, 0x08, 0x01, 0x18, 0x05, 0x20, 0x0E, 0x2A, 0x06, 0x74, 0x6B, 0x61, 0x64, 0x70, 0x74, 0x30, 0xED, 0x07, 0x3A, 0x0E, 0x70, 0x6F, 0x6C, 0x69, 0x63, 0x79, 0x5F, 0x61, 0x64, 0x70, 0x74, 0x5F, 0x76, 0x31, 0x42, 0x10, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x48, 0xAB, 0x04, 0x50, 0xF8, 0x03, 0x58, 0xD0, 0x98, 0x84, 0xBF, 0xB2, 0x99, 0xC8, 0xB7, 0x7C, 0x82, 0x01, 0x95, 0x80, 0x80, 0x80, 0x00, 0x0A, 0x0B, 0x62, 0x72, 0x6F, 0x6B, 0x65, 0x72, 0x5F, 0x64, 0x65, 0x6D, 0x6F, 0x10, 0xF0, 0x47, 0x18, 0xF1, 0x47, 0x20, 0x07 },
        },
        .{
            .event = events[5],
            .expected_hash = 7724507680433079684,
            .expected_binary_len = 106,
            .expected_binary_bytes = &.{ 0x66, 0x00, 0x00, 0x00, 0x08, 0x01, 0x18, 0x06, 0x20, 0x0F, 0x2A, 0x06, 0x74, 0x6B, 0x61, 0x67, 0x6E, 0x74, 0x30, 0xEE, 0x07, 0x3A, 0x0E, 0x70, 0x6F, 0x6C, 0x69, 0x63, 0x79, 0x5F, 0x70, 0x72, 0x6F, 0x70, 0x5F, 0x76, 0x31, 0x42, 0x10, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x48, 0x9A, 0x05, 0x50, 0xF9, 0x03, 0x58, 0x84, 0x8B, 0xF6, 0xA7, 0xF2, 0xD9, 0xBD, 0x99, 0x6B, 0x8A, 0x01, 0x9C, 0x80, 0x80, 0x80, 0x00, 0x0A, 0x15, 0x74, 0x72, 0x61, 0x64, 0x69, 0x6E, 0x67, 0x5F, 0x6F, 0x72, 0x64, 0x65, 0x72, 0x2E, 0x70, 0x72, 0x6F, 0x70, 0x6F, 0x73, 0x65, 0x10, 0xD4, 0x48, 0x18, 0x01 },
        },
        .{
            .event = events[6],
            .expected_hash = 11968303200201203335,
            .expected_binary_len = 99,
            .expected_binary_bytes = &.{ 0x5F, 0x00, 0x00, 0x00, 0x08, 0x01, 0x18, 0x07, 0x20, 0x10, 0x2A, 0x06, 0x74, 0x6B, 0x70, 0x6F, 0x6C, 0x79, 0x30, 0xEF, 0x07, 0x3A, 0x0E, 0x70, 0x6F, 0x6C, 0x69, 0x63, 0x79, 0x5F, 0x64, 0x65, 0x73, 0x74, 0x5F, 0x76, 0x31, 0x42, 0x10, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x06, 0x50, 0xFA, 0x03, 0x58, 0x87, 0xBD, 0xA7, 0xE1, 0x98, 0x8B, 0xFD, 0x8B, 0xA6, 0x01, 0x92, 0x01, 0x94, 0x80, 0x80, 0x80, 0x00, 0x0A, 0x0E, 0x62, 0x72, 0x6F, 0x6B, 0x65, 0x72, 0x5F, 0x61, 0x63, 0x63, 0x6F, 0x75, 0x6E, 0x74, 0x10, 0x08, 0x18, 0x00 },
        },
        .{
            .event = events[7],
            .expected_hash = 9594552197376279551,
            .expected_binary_len = 89,
            .expected_binary_bytes = &.{ 0x55, 0x00, 0x00, 0x00, 0x08, 0x01, 0x18, 0x08, 0x20, 0x11, 0x2A, 0x06, 0x74, 0x6B, 0x70, 0x6F, 0x6C, 0x79, 0x30, 0xF0, 0x07, 0x3A, 0x0E, 0x70, 0x6F, 0x6C, 0x69, 0x63, 0x79, 0x5F, 0x6C, 0x69, 0x6D, 0x74, 0x5F, 0x76, 0x31, 0x42, 0x10, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x48, 0xF8, 0x06, 0x50, 0xFB, 0x03, 0x58, 0xFF, 0x87, 0xBA, 0xFC, 0xBA, 0xCC, 0xAC, 0x93, 0x85, 0x01, 0x9A, 0x01, 0x8A, 0x80, 0x80, 0x80, 0x00, 0x08, 0x03, 0x10, 0xB0, 0x09, 0x18, 0xE8, 0x07, 0x20, 0x01 },
        },
        .{
            .event = events[8],
            .expected_hash = 7463280816050324954,
            .expected_binary_len = 119,
            .expected_binary_bytes = &.{ 0x73, 0x00, 0x00, 0x00, 0x08, 0x01, 0x18, 0x09, 0x20, 0x12, 0x2A, 0x06, 0x74, 0x6B, 0x70, 0x6F, 0x6C, 0x79, 0x30, 0xF1, 0x07, 0x3A, 0x0E, 0x70, 0x6F, 0x6C, 0x69, 0x63, 0x79, 0x5F, 0x61, 0x70, 0x72, 0x76, 0x5F, 0x76, 0x31, 0x42, 0x10, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x48, 0xE7, 0x07, 0x50, 0xFC, 0x03, 0x58, 0xDA, 0x8B, 0xAB, 0xDD, 0xC2, 0xCB, 0xB9, 0xC9, 0x67, 0xA2, 0x01, 0xA9, 0x80, 0x80, 0x80, 0x00, 0x0A, 0x15, 0x70, 0x61, 0x79, 0x6D, 0x65, 0x6E, 0x74, 0x5F, 0x72, 0x65, 0x74, 0x72, 0x79, 0x2E, 0x70, 0x72, 0x6F, 0x70, 0x6F, 0x73, 0x65, 0x12, 0x0D, 0x6D, 0x61, 0x6B, 0x65, 0x72, 0x5F, 0x63, 0x68, 0x65, 0x63, 0x6B, 0x65, 0x72, 0x18, 0xD4, 0x48 },
        },
        .{
            .event = events[9],
            .expected_hash = 2273216233812743884,
            .expected_binary_len = 114,
            .expected_binary_bytes = &.{ 0x6E, 0x00, 0x00, 0x00, 0x08, 0x01, 0x18, 0x0A, 0x20, 0x13, 0x2A, 0x06, 0x74, 0x6B, 0x70, 0x6F, 0x6C, 0x79, 0x30, 0xF2, 0x07, 0x3A, 0x0E, 0x70, 0x6F, 0x6C, 0x69, 0x63, 0x79, 0x5F, 0x64, 0x65, 0x6E, 0x79, 0x5F, 0x76, 0x31, 0x42, 0x10, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x48, 0xD6, 0x08, 0x50, 0xFD, 0x03, 0x58, 0xCC, 0xAD, 0xBD, 0x90, 0xEE, 0xC3, 0x85, 0xC6, 0x1F, 0xAA, 0x01, 0xA4, 0x80, 0x80, 0x80, 0x00, 0x0A, 0x13, 0x74, 0x72, 0x61, 0x64, 0x69, 0x6E, 0x67, 0x5F, 0x6F, 0x72, 0x64, 0x65, 0x72, 0x2E, 0x70, 0x6C, 0x61, 0x63, 0x65, 0x10, 0x11, 0x1A, 0x0B, 0x65, 0x6E, 0x76, 0x69, 0x72, 0x6F, 0x6E, 0x6D, 0x65, 0x6E, 0x74 },
        },
        .{
            .event = events[10],
            .expected_hash = 15826855321602201614,
            .expected_binary_len = 84,
            .expected_binary_bytes = &.{ 0x50, 0x00, 0x00, 0x00, 0x08, 0x01, 0x18, 0x0B, 0x20, 0x14, 0x2A, 0x06, 0x74, 0x6B, 0x6D, 0x65, 0x74, 0x72, 0x30, 0xF3, 0x07, 0x3A, 0x0E, 0x70, 0x6F, 0x6C, 0x69, 0x63, 0x79, 0x5F, 0x6D, 0x65, 0x74, 0x72, 0x5F, 0x76, 0x31, 0x42, 0x10, 0x0B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x48, 0xC5, 0x09, 0x50, 0xFE, 0x03, 0x58, 0x8E, 0xB0, 0xE6, 0xDC, 0xF8, 0xA1, 0x92, 0xD2, 0xDB, 0x01, 0xB2, 0x01, 0x85, 0x80, 0x80, 0x80, 0x00, 0x08, 0xB8, 0x49, 0x10, 0x29 },
        },
        .{
            .event = events[11],
            .expected_hash = 11385209391964570511,
            .expected_binary_len = 86,
            .expected_binary_bytes = &.{ 0x52, 0x00, 0x00, 0x00, 0x08, 0x01, 0x18, 0x0C, 0x20, 0x15, 0x2A, 0x06, 0x74, 0x6B, 0x72, 0x65, 0x70, 0x6C, 0x30, 0xF4, 0x07, 0x3A, 0x0E, 0x70, 0x6F, 0x6C, 0x69, 0x63, 0x79, 0x5F, 0x72, 0x65, 0x70, 0x6C, 0x5F, 0x76, 0x31, 0x42, 0x10, 0x0C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x48, 0xB4, 0x0A, 0x50, 0xFF, 0x03, 0x58, 0x8F, 0x87, 0xF5, 0xEB, 0xED, 0xF3, 0x98, 0x80, 0x9E, 0x01, 0xBA, 0x01, 0x87, 0x80, 0x80, 0x80, 0x00, 0x08, 0x9C, 0x4A, 0x10, 0x03, 0x18, 0x09 },
        },
    };
}
...
test "fromCodecEvent rejects unknown record type" {
    ...
    const fixture = makeFixtures()[0];
    var codec_event = toCodecEvent(fixture.event);
