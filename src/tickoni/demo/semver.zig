...
pub const Semver = struct {
    ...
    pub fn parse(raw: []const u8) ParseError!Semver {
        ...
        const major = std.fmt.parseInt(u64, it.next() orelse return error.ParseError, 10) catch
            return error.ParseError;
        const minor = std.fmt.parseInt(u64, it.next() orelse return error.ParseError, 10) catch
            return error.ParseError;
