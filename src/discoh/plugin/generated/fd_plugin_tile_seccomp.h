...
#ifndef HEADER_fd_src_discoh_plugin_generated_fd_plugin_tile_seccomp_h
#define HEADER_fd_src_discoh_plugin_generated_fd_plugin_tile_seccomp_h
...
static const uint sock_filter_policy_fd_plugin_tile_instr_cnt = 17;

static void populate_sock_filter_policy_fd_plugin_tile( ulong out_cnt, struct sock_filter out[ static 17 ], uint logfile_fd ) {
  FD_TEST( out_cnt >= 17 );
...
static const uint sock_filter_policy_fd_plugin_tile_instr_cnt = 0;

static void populate_sock_filter_policy_fd_plugin_tile( ulong out_cnt, struct sock_filter out[ static 1 ], uint logfile_fd ) {
  (void)out_cnt;
  (void)out;
  (void)logfile_fd;
...
#endif /* HEADER_fd_src_discoh_plugin_generated_fd_plugin_tile_seccomp_h */
