/* macOS: inet_aton is deprecated/removed, provide a fallback using inet_pton.
   On Linux we keep _GNU_SOURCE for the native inet_aton declaration. */
#if FD_HAS_MACOS
#include <arpa/inet.h>
#ifndef inet_aton
...
#endif
#endif
#define _GNU_SOURCE /* inet_aton on Linux */
