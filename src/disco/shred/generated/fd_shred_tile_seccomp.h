...
static const uint sock_filter_policy_fd_shred_tile_instr_cnt = 17;

static void populate_sock_filter_policy_fd_shred_tile( ulong out_cnt, struct sock_filter out[ static 17 ], uint logfile_fd ) {
  FD_TEST( out_cnt >= 17 );
...
static const uint sock_filter_policy_fd_shred_tile_instr_cnt = 0;

static void populate_sock_filter_policy_fd_shred_tile( ulong out_cnt, struct sock_filter out[ static 1 ], uint logfile_fd ) {
  (void)out_cnt;
  (void)out;
  (void)logfile_fd;
...
#endif /* HEADER_fd_src_disco_shred_generated_fd_shred_tile_seccomp_h */
