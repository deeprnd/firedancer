...
$(call make-unit-test,test_cpu_topo_platform_windows,test_cpu_topo_platform_windows,fd_disco fd_ballet fd_tango fd_waltz fd_util)
$(call run-unit-test,test_cpu_topo_platform_windows)
