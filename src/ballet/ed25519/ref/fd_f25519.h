...
fd_f25519_mul( fd_f25519_t * r,
               fd_f25519_t const * a,
               fd_f25519_t const * b ) {
  fiat_25519_carry_mul( (uint64_t (*)[5])&r->el, (uint64_t const (*)[5])&a->el, (uint64_t const (*)[5])&b->el );
  return r;
}
...
fd_f25519_sqr( fd_f25519_t * r,
               fd_f25519_t const * a ) {
  fiat_25519_carry_square( (uint64_t (*)[5])&r->el, (uint64_t const (*)[5])&a->el );
  return r;
}
...
fd_f25519_add( fd_f25519_t * r,
               fd_f25519_t const * a,
               fd_f25519_t const * b ) {
  fiat_25519_add( (uint64_t (*)[5])&r->el, (uint64_t const (*)[5])&a->el, (uint64_t const (*)[5])&b->el );
  fiat_25519_carry( (uint64_t (*)[5])&r->el, (uint64_t const (*)[5])&r->el );
  return r;
}
...
fd_f25519_sub( fd_f25519_t * r,
               fd_f25519_t const * a,
               fd_f25519_t const * b ) {
  fiat_25519_sub( (uint64_t (*)[5])&r->el, (uint64_t const (*)[5])&a->el, (uint64_t const (*)[5])&b->el );
  fiat_25519_carry( (uint64_t (*)[5])&r->el, (uint64_t const (*)[5])&r->el );
  return r;
}
...
fd_f25519_neg( fd_f25519_t * r,
               fd_f25519_t const * a ) {
  fiat_25519_opp( (uint64_t (*)[5])&r->el, (uint64_t const (*)[5])&a->el );
  return r;
}
...
fd_f25519_mul_121666( fd_f25519_t * r,
                      fd_f25519_t const * a ) {
  fiat_25519_carry_scmul_121666( (uint64_t (*)[5])&r->el, (uint64_t const (*)[5])&a->el );
  return r;
}
...
fd_f25519_frombytes( fd_f25519_t * r,
                     uchar const   buf[ 32 ] ) {
  fiat_25519_from_bytes( (uint64_t (*)[5])&r->el, buf );
  return r;
}
...
fd_f25519_tobytes( uchar               out[ 32 ],
                   fd_f25519_t const * a ) {
  fiat_25519_to_bytes( out, (uint64_t const (*)[5])&a->el );
  return out;
}
...
fd_f25519_if( fd_f25519_t *       r,
  ...
  fiat_25519_selectznz( (uint64_t (*)[5])&r->el, (uchar)cond, (uint64_t const (*)[5])&a1->el, (uint64_t const (*)[5])&a0->el );
  return r;
}
