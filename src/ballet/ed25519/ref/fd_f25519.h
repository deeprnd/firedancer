...
fd_f25519_sqr( fd_f25519_t * r,
               fd_f25519_t const * a ) {
  fiat_25519_carry_square( (uint64_t *)r->el, (uint64_t *)a->el );
  return r;
}
...
fd_f25519_add( fd_f25519_t * r,
               fd_f25519_t const * a,
               fd_f25519_t const * b ) {
  fiat_25519_add( (uint64_t *)r->el, (uint64_t *)a->el, (uint64_t *)b->el );
...
fd_f25519_sub( fd_f25519_t * r,
               fd_f25519_t const * a,
               fd_f25519_t const * b ) {
  fiat_25519_sub( (uint64_t *)r->el, (uint64_t *)a->el, (uint64_t *)b->el );
  fiat_25519_carry( (uint64_t *)r->el, (uint64_t *)r->el );
  return r;
}
...
fd_f25519_neg( fd_f25519_t * r,
               fd_f25519_t const * a ) {
  fiat_25519_opp( (uint64_t *)r->el, (uint64_t *)a->el );
  return r;
}
...
fd_f25519_mul_121666( fd_f25519_t * r,
                      fd_f25519_t const * a ) {
  fiat_25519_carry_scmul_121666( (uint64_t *)r->el, (uint64_t *)a->el );
  return r;
}
...
fd_f25519_tobytes( uchar               out[ 32 ],
                   fd_f25519_t const * a ) {
  fiat_25519_to_bytes( out, (uint64_t *)a->el );
  return out;
}
...
fd_f25519_if( fd_f25519_t *       r,
  ...
  fiat_25519_selectznz( (uint64_t *)r->el, (uchar)cond, (uint64_t *)a1->el, (uint64_t *)a0->el );
  return r;
}
